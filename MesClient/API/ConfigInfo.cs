...
namespace MesClient
{
    public class ConfigInfo
    {
        ...
        private static string _serialPortName = Helpers.IniHelper.ReadIniData("setting", "SerialPortName", "COM1", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AppSetting.ini"));

        private static string _printMachineName = Helpers.IniHelper.ReadIniData("setting", "PrintMachineName", "XXX", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AppSetting.ini"));

        private static int moveOffset = Convert.ToInt32(Helpers.IniHelper.ReadIniData("setting", "MoveOffset", "70", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AppSetting.ini")));

        private static int zoomIn = Convert.ToInt32(Helpers.IniHelper.ReadIniData("setting", "ZoomIn", "150", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AppSetting.ini")));

        private static int zoomOut = Convert.ToInt32(Helpers.IniHelper.ReadIniData("setting", "ZoomOut", "-120", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "AppSetting.ini")));
