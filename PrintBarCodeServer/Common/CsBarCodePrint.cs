...
namespace PrintBarCodeService.Common
{
    public class CsBarCodePrint
    {
        ...
        /// <returns></returns>
        public static bool PartBarCodePrint(string PrintName, int PointX, int PointY, string ContractName, string ProductName, string PartCode, string PartName, string MaterialName, string BarCode)
        {
            int rtn = 0;
