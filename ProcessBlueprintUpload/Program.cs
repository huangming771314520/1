using ProcessBlueprintUpload.Forms;
using System;
...
namespace ProcessBlueprintUpload
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Application.Run(new ProcessRouteBlueprintForm());
        }

        private static Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
        {
            string resourceName = "ProcessBlueprintUpload.Resources." + new AssemblyName(args.Name).Name + ".dll";
