...
namespace Zephyr.Core
{
    public class APP
    {
        ...
        //配置自动更新的字段
        public static string FIELD_UPDATE_PERSON = "ModifyPerson";
        public static string FIELD_UPDATE_DATE = "ModifyTime";
        public static string FIELD_CREATE_PERSON = "CreatePerson";
        public static string FIELD_CREATE_DATE = "CreateTime";
