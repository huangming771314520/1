...
namespace Zephyr.Core
{
    ...
    public partial class Cp
    {
        ...
        public static string SqlEqual(WhereData data) { return SQL(data, "{0} =  {1}"); }
        public static string NotNull(WhereData data) { return SQL(data, "({0} is not null or {0}<>'') "); }
        public static string IsNull(WhereData data) { return SQL(data, "{0} is {1}"); }
        ...
        public static string LessSql(WhereData data) { return SQL(data, "{0} < {1}"); }
        public static string LessEqualSql(WhereData data) { return SQL(data, "{0} <=  {1}"); }
        ...
        public static string LikeDate(WhereData data) { return SQL(data, " CONVERT(varchar,{0},20) like '%{1}%'"); }
        ...
        public static string Replace(WhereData data) { return SQL(data, " ISNULL({0},0)=0 or {0} not in ({1})"); }
        public static string CharindexGreat(WhereData data) { return SQL(data, "isnull(CHARINDEX('{0}',{1}),0)>0"); }
        public static string CharindexEqual(WhereData data) { return SQL(data, "isnull(CHARINDEX('{0}',{1}),0)=0"); }
