    ...
    public class Exporter
    {
        ...
        public static Exporter Instance()
        {
            ...
            if (context.Request.Form["fileType"] != null)
                if (context.Request.Form["downLoadType"]!=null)
                {
                    export.Export(context.Request.Form["fileType"], context.Request.Form["downLoadType"]);
                }
                else
                {
        ...
        public Exporter Export(string type,string downLoadType)
        {
            var export = GetActor<IExport>(_export, DEFAULT_EXPORT, type);
            return Export(export,downLoadType);
        }
        ...
        public Exporter Export(IExport export, string downLoadType)
        {
            if (_title == null)
            {
                _title = new List<List<Column>>();
