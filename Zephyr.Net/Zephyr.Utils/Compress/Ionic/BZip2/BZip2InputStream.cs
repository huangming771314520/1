...
// compile: msbuild
// not: csc.exe /t:library /debug+ /out:Zephyr.Utils.Ionic.BZip2.dll BZip2InputStream.cs BCRC32.cs Rand.cs
...
namespace Zephyr.Utils.Ionic.BZip2
{
    ...
    public class BZip2InputStream : System.IO.Stream
    {
        ...
        private int bsBuff;
        private int bsLive;
        private readonly Zephyr.Utils.Ionic.Crc.CRC32 crc = new Zephyr.Utils.Ionic.Crc.CRC32(true);
        private int nInUse;
        ...
        ///   {
        ///       using (var decompressor = new Zephyr.Utils.Ionic.BZip2.BZip2InputStream(fs))
        ///       {
