...
namespace Zephyr.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    public class ExcelExtractor : POIOLE2TextExtractor
    {
                    ...
                    for (int j = firstRow; j <= lastRow; j++)
                    {
                        ...
                        for (int k = firstCell; k < lastCell; k++)
                        {
                            ...
                            else
                            {
                                ...
                                Zephyr.Utils.NPOI.SS.UserModel.IComment comment = cell.CellComment;
        ...
        /// <returns></returns>
        private String ExtractHeaderFooter(Zephyr.Utils.NPOI.SS.UserModel.IHeaderFooter hf)
        {
            StringBuilder text = new StringBuilder();
