...
namespace Zephyr.Utils.NPOI.HSSF.Model
{
    using System;
    ...
    public class InternalSheet
    {
        ...
        /// </summary>
        /// <see cref="Zephyr.Utils.NPOI.HSSF.Record.DefaultRowHeightRecord"/>
        /// <see cref="Zephyr.Utils.NPOI.HSSF.Record.Record"/>
 ...
 */
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Zephyr.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
            ...
            SelectionRecord sel = (SelectionRecord)FindFirstRecordBySid(SelectionRecord.sid);
            sel.Pane = (byte)Zephyr.Utils.NPOI.SS.UserModel.PanePosition.LOWER_RIGHT;
        ...
        public PaneInformation PaneInformation
        {
            get
            {
                ...
                return new Zephyr.Utils.NPOI.SS.Util.PaneInformation(rec.X, rec.Y, rec.TopRow,
