...
namespace Zephyr.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private Zephyr.Utils.NPOI.SS.Formula.Formula _formula;
        ...
        public ArrayRecord(Zephyr.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
