...
namespace Zephyr.Utils.NPOI.HSSF.Record
{
    ...
    public class DVRecord : StandardRecord
    {
        ...
        private Zephyr.Utils.NPOI.SS.Formula.Formula _formula1;
        ...
        private Zephyr.Utils.NPOI.SS.Formula.Formula _formula2;
        ...
        public DVRecord(RecordInputStream in1)
        {
            ...
            _formula1 = Zephyr.Utils.NPOI.SS.Formula.Formula.Read(field_size_first_formula, in1);

            int field_size_sec_formula = in1.ReadUShort();
            _not_used_2 = in1.ReadShort();

            //read sec formula data condition
            _formula2 = Zephyr.Utils.NPOI.SS.Formula.Formula.Read(field_size_sec_formula, in1);
