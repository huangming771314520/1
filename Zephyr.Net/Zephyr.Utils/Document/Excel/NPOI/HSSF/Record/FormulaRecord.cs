 ...
 */
    internal class SpecialCachedValue
    {
        ...
        public Zephyr.Utils.NPOI.SS.UserModel.CellType GetValueType()
        {
            int typeCode = GetTypeCode();
            switch (typeCode)
            {
                case STRING: return Zephyr.Utils.NPOI.SS.UserModel.CellType.STRING;
                case BOOLEAN: return Zephyr.Utils.NPOI.SS.UserModel.CellType.BOOLEAN;
                case ERROR_CODE: return Zephyr.Utils.NPOI.SS.UserModel.CellType.ERROR;
                case EMPTY: return Zephyr.Utils.NPOI.SS.UserModel.CellType.STRING; // is this correct?
            }
    ...
    public class FormulaRecord : CellRecord
    {
        ...
        [NonSerialized]
        private Zephyr.Utils.NPOI.SS.Formula.Formula field_8_parsed_expr;
...
*/
        ...
        {
            field_8_parsed_expr = Zephyr.Utils.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
        ...
        public FormulaRecord(RecordInputStream in1):base(in1)
        {
                ...
                field_8_parsed_expr = Zephyr.Utils.NPOI.SS.Formula.Formula.Read(field_7_expression_len, in1,in1.Available());
        }
        /**
 ...
 */
        ...
        public Ptg[] ParsedExpression
        {
            ...
            set { field_8_parsed_expr = Zephyr.Utils.NPOI.SS.Formula.Formula.Create(value); }
        }
        public Zephyr.Utils.NPOI.SS.Formula.Formula Formula
        {
            get
            {
        ...
        public Zephyr.Utils.NPOI.SS.UserModel.CellType CachedResultType
        {
            get
            {
                if (specialCachedValue == null)
                {
                    return Zephyr.Utils.NPOI.SS.UserModel.CellType.NUMERIC;
                }
                return (Zephyr.Utils.NPOI.SS.UserModel.CellType)specialCachedValue.GetValueType();
            }
        }
