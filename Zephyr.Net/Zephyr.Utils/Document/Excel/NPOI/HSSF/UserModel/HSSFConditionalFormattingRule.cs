...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    using Zephyr.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Zephyr.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)Zephyr.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
