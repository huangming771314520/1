...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCreationHelper : ICreationHelper
    {
        ...
        public Zephyr.Utils.NPOI.SS.UserModel.IRichTextString CreateRichTextString(String text)
        {
        ...
        public Zephyr.Utils.NPOI.SS.UserModel.IHyperlink CreateHyperlink(HyperlinkType type)
        {
         ...
         */
        public Zephyr.Utils.NPOI.SS.UserModel.IFormulaEvaluator CreateFormulaEvaluator()
        {
         ...
         * @see Zephyr.Utils.NPOI.SS.usermodel.Drawing
         */
        public Zephyr.Utils.NPOI.SS.UserModel.IClientAnchor CreateClientAnchor()
        {
