...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFDataValidation : IDataValidation
    {
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#getConstraint()
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#CreatePromptBox(java.lang.String, java.lang.String)
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#getPromptBoxTitle()
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#getPromptBoxText()
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#CreateErrorBox(java.lang.String, java.lang.String)
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#getErrorBoxTitle()
         */
        ...
        /* (non-Javadoc)
         * @see Zephyr.Utils.NPOI.HSSF.UserModel.DataValidation#getErrorBoxText()
         */
        ...
        public DVRecord CreateDVRecord(HSSFSheet sheet)
        {
            ...
            Zephyr.Utils.NPOI.HSSF.UserModel.DVConstraint.FormulaPair fp = _constraint.CreateFormulas(sheet);
