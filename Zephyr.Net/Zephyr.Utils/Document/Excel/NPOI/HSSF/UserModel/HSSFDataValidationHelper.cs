...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFDataValidationHelper : IDataValidationHelper
    {
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateDateConstraint
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateExplicitListConstraint
         * (java.lang.String[])
         */
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateFormulaListConstraint
         * (java.lang.String)
         */
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateNumericConstraint
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTextLengthConstraint
         * (int, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTimeConstraint
         * (int, java.lang.String, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * Zephyr.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateValidation(org
         * .apache.poi.SS.UserModel.DataValidationConstraint,
         * Zephyr.Utils.NPOI.SS.Util.CellRangeAddressList)
         */
