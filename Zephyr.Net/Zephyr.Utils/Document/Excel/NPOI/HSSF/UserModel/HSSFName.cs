...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Zephyr.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Zephyr.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
