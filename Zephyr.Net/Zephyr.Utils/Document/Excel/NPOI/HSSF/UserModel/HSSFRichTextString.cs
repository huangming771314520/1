...
namespace Zephyr.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Zephyr.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Zephyr.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Zephyr.Utils.NPOI.SS.UserModel.IFont font)
        {
