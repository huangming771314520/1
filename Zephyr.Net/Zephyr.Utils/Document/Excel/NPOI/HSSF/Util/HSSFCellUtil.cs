...
namespace Zephyr.Utils.NPOI.HSSF.Util
{
    ...
    public class HSSFCellUtil
    {
        ...
        public static Zephyr.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            Zephyr.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
