...
using Zephyr.Utils.NPOI.POIFS.Properties;
using Zephyr.Utils.NPOI.POIFS.Dev;
using Zephyr.Utils.NPOI.POIFS.FileSystem;
using Zephyr.Utils.NPOI.POIFS.EventFileSystem;
using Zephyr.Utils.NPOI.Util;

namespace Zephyr.Utils.NPOI.POIFS.FileSystem
{
    /// <summary>
