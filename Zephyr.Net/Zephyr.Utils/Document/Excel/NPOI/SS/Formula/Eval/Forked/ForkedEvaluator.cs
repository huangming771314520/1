...
namespace Zephyr.Utils.NPOI.SS.Formula.Eval.Forked
{
     ...
     * 90% of memory consumption is due to loading of the {@link HSSFWorkbook} or {@link Zephyr.Utils.NPOI.xssf.usermodel.XSSFWorkbook}.
