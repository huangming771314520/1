...
namespace Zephyr.Utils.NPOI.SS.UserModel
{
    ...
    public interface IRow
    {
        ...
        /// (255 for *.xls, 1048576 for *.xlsx)
        /// </throws>
        ICell CreateCell(int column, Zephyr.Utils.NPOI.SS.UserModel.CellType type);
        ...
        /// <see cref="GetCell(int, Zephyr.Utils.NPOI.SS.UserModel.MissingCellPolicy)"/>
        ICell GetCell(int cellnum);

        /// <summary>
        /// Returns the cell at the given (0 based) index, with the specified {@link Zephyr.Utils.NPOI.SS.usermodel.Row.MissingCellPolicy}
        /// </summary>
