...
namespace Zephyr.Areas.CommonWrap.SendEmail
{
    public class EmailManage
    {
        public static string sendMail(string topic, string attachmentUrl, string body)
        {
            string sendAddress = "huangming3848@qq.com";//发件者邮箱地址
            string sendPassword = "msmcuahljiltbbce";//发件者邮箱密码
            string receiveAddress = "641311859@qq.com";//收件人收箱地址
