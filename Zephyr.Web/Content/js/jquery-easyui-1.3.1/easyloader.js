...
(function () {
    var _1 = {
        jqueryui: {
            js: "/Content/js/jquery-plugin/jquery-ui/js/jquery-ui.min.js",
        ...
        datagrid: {
            ...
            css: "datagrid.css",
            dependencies: ["panel", "resizable", "linkbutton", "splitbutton", "pagination"]
        },
        treegrid: {
    ...
    easyloader = {
        ...
        load: function (_1f, _20) {
            if (/\.css$/i.test(_1f)) {
                if (/^http/i.test(_1f) || _1f.indexOf('/') > -1) {
                    _c(_1f, _20);
                } else {
