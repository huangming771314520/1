...
//modify by liwenxiang for add splitbutton start
...
//modify by liwenxiang for add splitbutton end
}
}
}
}else{
...
$.ajax({ type: opts.method, url: opts.url, data: _1ed, contentType: "application/json", dataType: "json", success: function (data) {
_1ee(data);
},error:function(){
