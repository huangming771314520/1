...
(function ($) {
    ...
    var _687 = {
        render: function (_688, _689, _68a) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_6c2, _6c3) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _6c4, dataType: "json", success: function (data) {
                    _6c5(data);
                }, error: function () {
            ...
            getTr: function (_6c7, _6c8, type, _6c9) {
                type = type || "body";
                _6c9 = _6c9 || 0;
...
(function ($) {
    ...
    var _7ab = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_7ac, _7ad, _7ae) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _7ab, loader: function (_7e2, _7e3, _7e4) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _7e2, dataType: "json", success: function (data) {
                    _7e3(data);
                }, error: function () {
            ...
            getTr: function (_7e6, id, type, _7e7) {
                type = type || "body";
                _7e7 = _7e7 || 0;
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_88f) {
            return _88f;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _890, dataType: "json", success: function (data) {
                    _891(data);
                }, error: function () {
...
(function ($) {
    function _8d1(_8d2) {
        ...
        $(_8d2).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _8d4();
        ...
        function _8d5() {
            ...
            $.extend(_8d3.calendar.calendar("options"), {
...
(function ($) {
    ...
    function _923(_924) {
        ...
        _926.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_945) {
            return _945;
