...
(function ($) {
    ...
    function _47(_48) {
        ...
        if (_4a.pagination) {
            ...
            _51.pagination({
                total: 0, pageNumber: _4a.pageNumber, pageSize: _4a.pageSize, pageList: _4a.pageList, onSelectPage: function (_53, _54) {
                    _4a.pageNumber = _53;
                    _4a.pageSize = _54;
    ...
    function _5d(_5e) {
        ...
        _63.each(function () {
            $(this).resizable({
                handles: _69, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _5f.resizing = true;
