    ...
    $.extend($.fn.datagrid.defaults.editors, {
        textAreanew: {
            init: function (container, options) {
                var EndGrid = options.EndGrid;
                var input = $("<textarea rows=\"10\" style=\"z-index:100;position:absolute;top:30px;\" class=\"datagrid-editable-input\"></textarea>").appendTo(container);
                //input.focus();
                input.blur(function () {
                    var eaRows = $(EndGrid).datagrid('getRows');
                    $(eaRows).each(function (index, item) {
                        $(EndGrid).datagrid('endEdit', index);
                    });
                });
                return input;
            },
