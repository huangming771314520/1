...
(function ($) {
    ...
    }, length: { validator: function (_40a, _40b) {
        var len = $.trim(_40a).length;
        return len >= _40b[0] && len <= _40b[1];
    }, message: "Please enter a value between {0} and {1}."
    }, remote: { validator: function (_40c, _40d) {
        var data = {};
        data[_40d[1]] = _40c;
...
(function ($) {
    ...
    $.fn.calendar.parseOptions = function (_454) { var t = $(_454); return $.extend({}, $.parser.parseOptions(_454, ["width", "height", { firstDay: "number", fit: "boolean", border: "boolean"}])); }; $.fn.calendar.defaults = { width: 180, height: 180, fit: false, border: true, firstDay: 0, weeks: [ "日","一","二", "三", "四", "五", "六"], months: ["一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月", "十二月"], year: new Date().getFullYear(), month: new Date().getMonth() + 1, current: new Date(), onSelect: function (date) { } };
})(jQuery);
...
(function ($) {
    function _891(_892) {
        ...
        function _895() {
            ...
            var _myCustomDate = $("<a href=\"javascript:void(0)\" class=\"datebox-clear\"></a>").html(opts.clearText).appendTo(_898);
            ...
            _myCustomDate.click(function () {
                //$(_892).combo("hidePanel");
                $(_892).datebox("setValue", "");
                $(_892).combo("hidePanel");
            });
        };
        function _894() {
    ...
    }, currentText: "今天", closeText: "关闭", clearText: "清除", okText: "确认", formatter: function (date) {
